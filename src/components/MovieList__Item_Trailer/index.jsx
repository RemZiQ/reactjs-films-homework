...
const Trailer = ({ id, store }) => {
  ...
  return (
    <div className='movieList__item__trailerContainer' id={`trailerContainer${id}`}>
      ...
      <iframe src={store} name="trailer" width='1080' height='760' frameBorder="0" allowFullScreen className='movieList__item__trailer'></iframe>
    </div>
  )
...
const mapStateToProps = (state) => {
  return {store: state.currentTrailer}
}
